...
public class TopsyDriver extends Configured implements Tool {
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(getConf(), TopsyDriver.class);
		...
		conf.setJarByClass(TopsyDriver.class);
		conf.setMapperClass(TopsyMapper.class);
		conf.setReducerClass(TopsyReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TopsyDriver(), args);
		System.exit(res);
	}
}